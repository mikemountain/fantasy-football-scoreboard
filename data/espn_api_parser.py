        ...
        try:
            ...
            for matchup in matchups['schedule']:
                ...
                if int(matchup['home']['teamId']) == self.team_id:
                    ...
                    matchup_info['user_score'] = float(matchup['home']['rosterForCurrentScoringPeriod']['appliedStatTotal'])
                    ...
                    matchup_info['opp_score'] = float(matchup['away']['rosterForCurrentScoringPeriod']['appliedStatTotal'])
                    ...
                    matchup_info['user_score'] = float(matchup['away']['rosterForCurrentScoringPeriod']['appliedStatTotal'])
                    ...
                    matchup_info['opp_score'] = float(matchup['home']['rosterForCurrentScoringPeriod']['appliedStatTotal'])
            return matchup_info
